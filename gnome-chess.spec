...
Source0  : https://download.gnome.org/sources/gnome-chess/42/gnome-chess-42.1.tar.xz
...
%prep
%setup -q -n gnome-chess-42.1
cd %{_builddir}/gnome-chess-42.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660165653
