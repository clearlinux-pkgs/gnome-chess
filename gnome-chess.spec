...
Source0  : https://download.gnome.org/sources/gnome-chess/40/gnome-chess-40.1.tar.xz
...
%prep
%setup -q -n gnome-chess-40.1
cd %{_builddir}/gnome-chess-40.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622757935
...
cp %{_builddir}/gnome-chess-40.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-chess/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/gnome-chess-40.1/data/pieces/simple/COPYING.html %{buildroot}/usr/share/package-licenses/gnome-chess/47f1cad086978c84323c31985d84a78dcf1318bb
cp %{_builddir}/gnome-chess-40.1/help/C/license.page %{buildroot}/usr/share/package-licenses/gnome-chess/a5205a5ed7fcb904170e8d9ce7ad75fd6d541907
