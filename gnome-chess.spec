...
Source0  : https://download.gnome.org/sources/gnome-chess/43/gnome-chess-43.1.tar.xz
...
%prep
%setup -q -n gnome-chess-43.1
cd %{_builddir}/gnome-chess-43.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673300629
