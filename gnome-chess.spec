...
Source0  : https://download.gnome.org/sources/gnome-chess/3.38/gnome-chess-3.38.1.tar.xz
...
%prep
%setup -q -n gnome-chess-3.38.1
cd %{_builddir}/gnome-chess-3.38.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607369495
...
cp %{_builddir}/gnome-chess-3.38.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-chess/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/gnome-chess-3.38.1/data/pieces/simple/COPYING.html %{buildroot}/usr/share/package-licenses/gnome-chess/47f1cad086978c84323c31985d84a78dcf1318bb
cp %{_builddir}/gnome-chess-3.38.1/help/C/license.page %{buildroot}/usr/share/package-licenses/gnome-chess/a5205a5ed7fcb904170e8d9ce7ad75fd6d541907
...
/usr/share/help/da/gnome-chess/figures/logo.png
/usr/share/help/da/gnome-chess/figures/logo32.png
