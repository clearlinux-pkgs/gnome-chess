...
Source0  : https://download.gnome.org/sources/gnome-chess/43/gnome-chess-43.0.tar.xz
...
%prep
%setup -q -n gnome-chess-43.0
cd %{_builddir}/gnome-chess-43.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663950556
