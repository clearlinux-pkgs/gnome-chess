...
Version  : 42.0
Release  : 12
URL      : https://download.gnome.org/sources/gnome-chess/42/gnome-chess-42.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-chess/42/gnome-chess-42.0.tar.xz
...
%prep
%setup -q -n gnome-chess-42.0
cd %{_builddir}/gnome-chess-42.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647548631
...
cp %{_builddir}/gnome-chess-42.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-chess/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/gnome-chess-42.0/data/pieces/simple/COPYING.html %{buildroot}/usr/share/package-licenses/gnome-chess/47f1cad086978c84323c31985d84a78dcf1318bb
cp %{_builddir}/gnome-chess-42.0/help/C/license.page %{buildroot}/usr/share/package-licenses/gnome-chess/a5205a5ed7fcb904170e8d9ce7ad75fd6d541907
