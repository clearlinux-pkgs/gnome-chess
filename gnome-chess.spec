...
Source0  : https://download.gnome.org/sources/gnome-chess/47/gnome-chess-47.0.tar.xz
...
%prep
%setup -q -n gnome-chess-47.0
cd %{_builddir}/gnome-chess-47.0
%patch -P 1 -p1
pushd ..
cp -a gnome-chess-47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726761950
